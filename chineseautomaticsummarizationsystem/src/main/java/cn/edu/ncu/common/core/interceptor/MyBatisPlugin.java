...
public class MyBatisPlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        List<String> methodStrList = StringUtil.splitConvertToList(id, "\\.");
    ...
    public DataScopeSqlConfigService dataScopeSqlConfigService() {
        return (DataScopeSqlConfigService) ApplicationContextHolder.getBean("dataScopeSqlConfigServiceImpl");
    }
