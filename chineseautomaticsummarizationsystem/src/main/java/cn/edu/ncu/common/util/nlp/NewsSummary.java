...
public class NewsSummary {
    ...
    public NewsSummary(){
        this.loadStopWords("D:\\Git\\stopwords\\百度停用词表.txt");
    ...
    private List<String> IKSegment(String text) throws IOException {
        return SegmentUtil.segment(text);
    }
...
//            List<String> words= HanLP.segment(sentence);
    ...
    * @Date:
    */
    public String SummaryMeanstdTxt(String text) throws IOException {
        //将文本拆分成句子列表
...
//        List<Term> words1= HanLP.segment(text);
        ...
        System.err.println(scoresLinkedMap);
    ...
    * @Date:
    */
    public String SummaryTopNTxt(String text) throws IOException {
        //将文本拆分成句子列表
        List<String> sentencesList = this.SplitSentences(text);
...
//        List<Term> words1= HanLP.segment(text);
    ...
    * @Date:
    */
    public String SummaryMMRNTxt(String text) throws IOException {
        //将文本拆分成句子列表
        List<String> sentencesList = this.SplitSentences(text);
...
//        List<Term> words1= HanLP.segment(text);
     ...
     * @return
     */
    public String summarize(String text,String style) throws IOException {
        try {
