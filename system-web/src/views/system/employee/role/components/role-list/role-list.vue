...
export default {
  ...
  watch: {
    roleId(val) {
      if (val) {
        this.employeeData.roleId = parseInt(this.roleId);
  ...
  methods: {
    ...
    deleteEmployees() {
      ...
      object.roleId = parseInt(this.roleId);
    ...
    changePage(number) {
      ...
      object.pageNum = parseInt(number);
      object.pageSize = parseInt(this.pageSize);
      object.sort = '';
    ...
    confirmPrepAddEmployees() {
      ...
      this.submitPrepAddEmployeesData.roleId = parseInt(this.roleId);
    ...
    async getListAllEmployee() {
      this.$isShowTablesLoading = true;
      try {
        let response = await roleApi.getAllListEmployee(parseInt(this.roleId));
