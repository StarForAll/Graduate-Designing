...
export default {
  ...
  methods: {
    ...
    hasMenuChange (menu, serverMenuMap) {
      ...
      if(serverMenu.parentKey===undefined){
        serverMenu.parentKey=null;
      }
      if (serverMenu) {
        isChange =
      ...
      if (isChange) {
        console.log('==============  change menu : ', menu.menuName,menu.menuKey,menu.parentKey,menu.url, '   ===================');
        console.log('==========change serverMenu : ', serverMenu.menuName,serverMenu.menuKey,serverMenu.parentKey,serverMenu.url, '   ===================');
        this.menusChange = true;
