  ...
  methods: {
    ...
    async getTaskList() {
      try {
        ...
        this.pageNum = parseInt(result.data.pageNum);
        this.pageSize = parseInt(result.data.pageSize);
      } catch (e) {
        //TODO zhuoda sentry
        console.error(e);
      } finally {
    ...
    async getTaskLog() {
      ...
      this.logTotal = parseInt(result.data.total);
      this.logPageNum = parseInt(result.data.pageNum);
      this.logPageSize = parseInt(result.data.pageSize);
      this.hasLog = true;
      this.logModal = true;
    },
    // 分页
    ...
    changeLogPageNum(pageNum) {
      this.logPageNum = parseInt(pageNum);
      this.getTaskLog();
    },
    // 删除任务
    async deleteTask(id) {
